...
public enum ErrorEnum {
    ...
    INCORRECT_CONTENT_OF_COLLECTION("ERR027", "글의 본문은 "+ CollectionContentLimitEnum.CONTENT_LENGTH_MAX.getValue() +"자를 넘겨서는 안됩니다."),
    INCORRECT_TITLE_OF_COLLECTION("ERR028", "글의 제목은 "+ CollectionContentLimitEnum.TITLE_LENGTH_MAX.getValue() +"자를 넘겨서는 안됩니다."),
    ...
    INCORRECT_CONTENT_OF_POST("ERR049", "글의 본문은 "+ CollectionContentLimitEnum.CONTENT_LENGTH_MAX.getValue() +"자를 넘겨서는 안됩니다."),
    INCORRECT_POST_IMAGE_LENGTH("ERR050", "글에 허용되는 이미지의 갯수는 " + ContentsLengthEnum.POST_IMAGE_MAX.getLength() + "개가 최대입니다."),
    INCORRECT_TITLE_OF_POST("ERR051", "글의 제목은 " + CollectionContentLimitEnum.TITLE_LENGTH_MAX.getValue() + "자를 넘겨서는 안됩니다."),
