    ...
    static class InitAddDummyService {
        ...
        public void init() throws Exception {
            ...
            for (int i = 0; i < i2; i++) {
                ...
                String accountId = arr.get((int) (Math.random() * 10)) + "" + arr.get((int) (Math.random() * 10)) + "" + arr.get((int) (Math.random() * 10));
                String accountPw = arr.get((int) (Math.random() * 10)) + "" + arr.get((int) (Math.random() * 10)) + "" + arr.get((int) (Math.random() * 10));
                String name = arr.get((int) (Math.random() * 10)) + "" + arr.get((int) (Math.random() * 10));
                String nickname = arr.get((int) (Math.random() * 10)) + "" + arr.get((int) (Math.random() * 10));

                if (all.stream().noneMatch(mem -> mem.getAccountId().equals(accountId) && mem.getNickname().equals(nickname)))
                    createMemberVOs.add(new CreateMemberVO(accountId, accountPw, name, nickname, LocalDate.now(), "", null));
            }
